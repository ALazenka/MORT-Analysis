...
class D3Chart extends Component {
  ...
  updateTable() {
    ...
    ajax.onload = (e) => {
      ...
      window.globalData[0]["values"].push([currentTimeStamp ,scoreMaps["anger"] || 0]);
      window.globalData[1]["values"].push([currentTimeStamp ,scoreMaps["contempt"] || 0]);
      window.globalData[2]["values"].push([currentTimeStamp ,scoreMaps["disgust"] || 0]);
      window.globalData[3]["values"].push([currentTimeStamp ,scoreMaps["fear"] || 0]);
      window.globalData[4]["values"].push([currentTimeStamp ,scoreMaps["happiness"] || 0]);
      window.globalData[5]["values"].push([currentTimeStamp ,scoreMaps["neutral"] || 0]);
      window.globalData[6]["values"].push([currentTimeStamp ,scoreMaps["sadness"] || 0]);
      window.globalData[7]["values"].push([currentTimeStamp ,scoreMaps["surprise"] || 0]);
